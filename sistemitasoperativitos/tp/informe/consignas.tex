...
\resultadoTPtexto{Al ultilizar el comando cd sin par'ametros, si existe la variable HOME entonces se hace un chdir a ese path.}
\end{enumerate}
...
\resultadoTP{-rw-r--r-- 3 root root 981 2008-10-08 01:11 /etc/passwd}
...
\resultadoTP{sudo umount /media/cdrom}

\item \texttt{uptime} ?`Cuanto tiempo lleva ejecutando su m'aquina virtual?
\resultadoTP{18:48:33 up  6:45,  2 users,  load average: 0.00, 0.00, 0.00}

\item \texttt{uname} ?`Qu'e versi'on del kernel de Linux est'a utilizando?
\resultadoTP{uname -a:  Linux esparrago 2.6.24-19-virtual \#1 SMP Wed Jun 18 15:52:10 UTC 2008 i686 GNU/Linux}
...
\resultadoTP{ls -R /etc/ > /home/mlopez/tp/config}
...
\resultadoTP{sort /etc/passwd >> /home/mlopez/tp/config}
