...
dirección virtual y notifica al kernel de esta falla. Existen dos
alternativas para solucionar esto: o la p'agina de memoria es
volcada a un archivo y viceversa; o el proceso está haciendo
referencia a una zona de memoria no permitida.

Si el administrador de memoria detecta un acceso no permitido (a la
memoria) notifica al proceso con una señal. Si el proceso no sabe
como manejar esta señal, el proceso es finalizado.
